      ...
      <header className="bg-webinar-primary text-white py-16">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="farsi flex flex-col items-start space-y-4">
            <h1 className="text-4xl md:text-5xl font-bold">توانمندسازی تحقیقات آکادمیک به کمک هوش مصنوعی</h1>
            ...
            <div className="farsi">
              ...
              <WebinarSection title="توضیحات" icon={<Info />}>
                <div className="space-y-4">
                  <p className="font-bold">توانمندسازی تحقیقات آکادمیک به کمک هوش مصنوعی</p>
              ...
              <WebinarSection title="تاریخ‌ها و موضوعات کارگاه‌ها" icon={<Calendar />}>
                <div className="space-y-6">
                  <div className="bg-webinar-light p-4 rounded-lg border-r-4 border-webinar-primary">
                    ...
                    <p>📅 دوشنبه، ۲۹ اردیبهشت ۱۴۰۴ | 🕑 ساعت ۱۳:۰۰ به وقت تهران</p>
              ...
              <WebinarSection title="سخنران ویژه" icon={<Users />}>
                <div className="bg-gradient-to-r from-webinar-light to-indigo-100 p-6 rounded-lg">
                  ...
                  <p>پدرام پژوهشگر، مدرس و طراح سامانه‌های هوش مصنوعی و نویسنده کتاب «هوش مصنوعی: درس‌هایی نامتعارف» است. او مدرک دکترای خود را در رشته مهندسی برق و کامپیوتر از دانشگاه بریتیش کلمبیا دریافت کرده و مخترع پنج پتنت ثبت‌شده در حوزه هوش مصنوعی در آمریکا است که توسط شرکت متا خریداری شده‌اند. پدرام با ترکیبی از دانش فنی عمیق و بینش آکادمیک، در زمینه کمک به سازمان‌ها برای بهره‌گیری اخلاق‌مدار و مؤثر از هوش مصنوعی فعالیت می‌کند.</p>
                </div>
              </WebinarSection>
